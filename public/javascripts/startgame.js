...
/**
 * Fucion encargada de inyectar 1 juego a my sql utilizando una peticion y direccionamiento
 * a la siguiente pargina para comenzar a jugar
 */
async function startgame() {
  const balot = document.getElementById("loadgame");

  balot.innerText = JSON.stringify(
    "JUEGO EN PROCESO EMPEZAREMOS EN 30 SEGUNDOS"
  );
